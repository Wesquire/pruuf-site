...
{robots}<link rel="canonical" href="https://pruuf.app/{slug}">
<meta property="og:type" content="website">
<meta property="og:title" content="{title}">
<meta property="og:description" content="{description}">
<meta property="og:image" content="https://pruuf.app/assets/img/og-card.png">
<meta property="og:url" content="https://pruuf.app/{slug}">
  ...
  <div class="wrap doc">
    ...
    <ul>
      ...
      <li><strong>Your contacts.</strong> When you add a family member, the app
        ...
        to pre-fill a text message on your device. That information is never sent
        to us and never leaves your phone.</li>
...
<section class="section section--tight">
  <div class="wrap doc">
    ...
    <ul>
      <li><strong>If we lower the price, you get the lower price</strong> &mdash;
        existing subscribers included, automatically, with nothing to claim.</li>
      <li><strong>If we raise the price, you keep the one you signed up at.</strong>
        Only new subscribers pay more. This holds even if you cancel and come back
        later, which is more than Apple&rsquo;s own price-preservation gives
        you.</li>
    </ul>
